...
class Generator(QWidget):
    ...
    def initUI(self):
        ...
        label1.setText("Choose your style and content images first")
        ...
        label2.setText("Choose your style image:")
        ...
        label3.setText("Choose your content image:")
    ...
    def setFilePath1(self):
        ...
        style_image_path, imgType = QtWidgets.QFileDialog.getOpenFileName(self, "Choose image", "",
                                                                          "*.jpg;;*.png;;All Files(*)")
    ...
    def setFilePath2(self):
        ...
        content_image_path, imgType = QtWidgets.QFileDialog.getOpenFileName(self, "Choose image", "",
                                                                            "*.jpg;;*.png;;All Files(*)")
